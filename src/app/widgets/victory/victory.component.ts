...
import { AddVictoryModalComponent } from '@app/widgets/victory/modal/add-victory-modal/add-victory-modal.component';
import { UserCardWidgetComponent } from '@app/widgets/user-card-widget/user-card-widget.component';
